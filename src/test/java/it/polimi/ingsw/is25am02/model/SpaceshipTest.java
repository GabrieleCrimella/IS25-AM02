...
class SpaceshipTest {
    ...
    void check_calculate_num_alive() {
        ...
        game.getPlayers().get(1).setStatePlayer(StatePlayerType.CORRECT_SHIP);
        game.getPlayers().get(2).setStatePlayer(StatePlayerType.CORRECT_SHIP);
        game.getPlayers().get(3).setStatePlayer(StatePlayerType.CORRECT_SHIP);
        game.getCurrentCard().setStateCard(StateCardType.FINISH);
        game.ready(player1);
        game.ready(player2);
        game.ready(player3);
        game.ready(player4);
        assertEquals(6, game.getPlayers().getFirst().getSpaceship().calculateNumAlive());
    }
...
/*
    ...
    void test_should_check_that_mask_level_0_is_correct(){
        ...
        for (int i=0;i<12;i++){
           int x=i;
            assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), x, 0, cabin1);});
        }
        //controllo riga vuota 1
        for (int i=0;i<12;i++){
            int x=i;
            assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), x, 1, cabin1);});
        }
        //controllo riga vuota 2
        for (int i=0;i<12;i++){
            int x=i;
            assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), x, 2, cabin1);});
        }
        //controllo riga vuota 3
        for (int i=0;i<12;i++){
            int x=i;
            assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), x, 3, cabin1);});
        }
        //controllo riga vuota 4
        for (int i=0;i<12;i++){
            int x=i;
            assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), x, 4, cabin1);});
        }
        //controllo riga 5
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 0, 5, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 1, 5, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 2, 5, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 3, 5, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 4, 5, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 5, 5, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 6, 5, cabin1);});
        assertDoesNotThrow( () -> {spaceship1.addTile(player1.getNickname(), 7, 5, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 8, 5, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 9, 5, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 10, 5, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 11, 5, cabin1);});

        //controllo riga 6
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 0, 6, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 1, 6, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 2, 6, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 3, 6, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 4, 6, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 5, 6, cabin1);});
        ...
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 9, 6, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 10, 6, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 11, 6, cabin1);});

        //controllo riga 7
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 0, 7, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 1, 7, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 2, 7, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 3, 7, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 4, 7, cabin1);});
        ...
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 10, 7, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 11, 7, cabin1);});

        //controllo riga 8
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 0, 8, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 1, 8, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 2, 8, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 3, 8, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 4, 8, cabin1);});
        ...
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 10, 8, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 11, 8, cabin1);});

        //controllo riga 9
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 0, 9, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 1, 9, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 2, 9, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 3, 9, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 4, 9, cabin1);});
        ...
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 7, 9, cabin1);});
        ...
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 10, 9, cabin1);});
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 11, 9, cabin1);});

        //controllo riga vuota 10
        for (int i=0;i<12;i++){
            int x=i;
            assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), x, 10, cabin1);});
        }
        //controllo riga vuota 11
        for (int i=0;i<12;i++){
            int x=i;
            assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), x, 11, cabin1);});
        }
    ...
    void test_should_check_that_mask_level_1_is_correct(){
        ...
        assertThrows(Exception.class, () -> {spaceship1.addTile(player1.getNickname(), 7, 5, cabin1);});
...
*/
    ...
    void test_get_Up_tile(){
        ...
        assertEquals(TileType.BATTERY, spaceship1.getSpaceshipIterator().getUpTile(spaceship.getTile(7,7).get()).get().getType());
    }
    ...
    void test_should_check_calculate_exposed_connectors(){
        ...
        game.shipFinished(player3);
        game.shipFinished(player4);
        assertEquals(9, game.getPlayers().getFirst().getSpaceship().calculateExposedConnectors());
    }
...
//4 spaceship
        ...
        assertEquals(true,spaceship1.isExposed(RotationType.NORTH, 8));
        assertEquals(false,spaceship1.isExposed(RotationType.EAST, 7));
        assertEquals(false,spaceship1.isExposed(RotationType.EAST, 6));
        assertEquals(true,spaceship1.isExposed(RotationType.EAST, 5));
        assertEquals(true,spaceship1.isExposed(RotationType.WEST, 7));
        assertEquals(true,spaceship1.isExposed(RotationType.SOUTH, 8));
