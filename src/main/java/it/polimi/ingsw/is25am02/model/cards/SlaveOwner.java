...
public class SlaveOwner extends Enemies{
    ...
    public SlaveOwner(int level, int cannonPowers, int daysLost, int credit, int humanLost, String imagepath) {
        super(level, cannonPowers, daysLost, credit, StateCardType.DECISION, imagepath);
