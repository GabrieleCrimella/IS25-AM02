...
public abstract class Enemies extends Card {
    ...
    public Enemies(int level, int cannonPowers, int daysLost, int credit, StateCardType stateCard, String imagepath, String comment,boolean testFlight) {
        super(level, stateCard, imagepath,comment,testFlight);
