...
public class BrownCabin extends Cabin{
    public BrownCabin(TileType t, ConnectorType[] connectors, RotationType rotationType, int id, int numHuman, int numPurpleAlien, int numBrownAlien) {
