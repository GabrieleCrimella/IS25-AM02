...
public class GraphicPrinter {
    ...
    public void printCardComment() {
        ...
        if (game.getCurrentState().getCurrentCard().getCardType() == CardType.METEORITES_STORM || (game.getCurrentState().getCurrentCard().getCardType() == CardType.WARZONE1) || game.getCurrentState().getCurrentCard().getCardType() == CardType.WARZONE2 || game.getCurrentState().getCurrentCard().getCardType() == CardType.PIRATE) { //mettere le altre carte
